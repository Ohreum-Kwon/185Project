...
%  
% # Learn about the algorithm behind the <docid:driving_ref#mw_c24d94d4-eda0-4afc-a933-ae8ccad7c525 Lateral Controller Stanley> block.  
...
% <docid:driving_ref#mw_0abe0f52-f25a-4829-babb-d9bafe8fdbf3 Scenario Reader> 
% block to read the roads and actors from the LateralControl.mat scenario file.
variant = 'LateralControlTutorial/Lateral Controller';
set_param(variant, 'LabelModeActivechoice', 'Kinematic');
%%
